...
public class NoteFrequency {
    public static void main(String[] args) {
        ...
        String noteInput = keyboard.nextLine();

        if ((!Character.isUpperCase(noteInput.charAt(0)))|| (noteInput.length() > 2 && Character.isDigit(noteInput.charAt(1)))) {
            System.out.println();
            System.out.println("Please enter a valid note name and capitalize it!!");
            System.exit(6);
        } else {
            System.out.println();
            System.out.print("Please enter an octave designation: ");
        }
        ...
        if (octave < 0 || octave > 8) {
            System.out.println();
            System.out.println("Please enter a valid octave designation from a piano keyboard!!");
            System.exit(6);
        }

        String note = noteInput + octaveString;
        System.out.println();
        System.out.println("You entered: " + note);
